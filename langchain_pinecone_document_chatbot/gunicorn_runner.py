...
from uvicorn.workers import UvicornWorker as BaseUvicornWorker  # type: ignore

try:
    import uvloop  # type: ignore # noqa: WPS433 (imported but unused)
except ImportError:
    ...
    def __init__(  # noqa: WPS211 (Too many args)
        ...
        **kwargs: Any,
        ...
        self.options = {
            "bind": f"{host}:{port}",
            "workers": 3,
            "worker_class": "langchain_pinecone_document_chatbot.gunicorn_runner.UvicornWorker",
            **kwargs,
        }
        self.app = app
        super().__init__()
